...
(defvar xlsl-mode-version nil "xlsl-mode version string.")
...
(defvar xlsl-macros
  '("afootell" "aftell" "afwis" "AgentIsHere" "apf" "arst" "BbxCenterPos" "BbxCornerPos" "BbxCorners" "BbxFrontBotLeftCorner" "BbxFrontBotRightCorner" "BbxFrontTopLeftCorner" "BbxFrontTopRightCorner" "BbxRearBotLeftCorner" "BbxRearBotRightCorner" "BbxRearTopLeftCorner" "BbxRearTopRightCorner" "BbxScale" "Begstr" "ClrStatus" "CompStatus" "continue" "DEBUGmsg" "DEBUGmsg0" "DEBUGmsg1" "DEBUGmsg2" "Dist2Line" "Endstr" "Enlist" "ERRORmsg" "GetMenuChannel" "GetPrimText" "GLPP" "HasInventory" "HasStatus" "IfAttached" "IfEnlist" "IfElseEnlist" "IfMessage" "IfNotEnlist" "IfNStatus" "IfNStatusDo" "IfStatus" "IfStatusDo" "InFrontX" "InFrontXThisRoot" "InFrontXVecR" "InFrontXVecRr" "InFrontY" "InFrontYVecRr" "InFrontZ" "Instr" "InvIsCopy4Owner" "LoopDown" "LoopUp" "MultVec" "MultVec2" "NoPin" "NotInventory" "NotOnlst" "NotStatus" "ObjIsCopy4Owner" "ObjectMaybeNotAround" "Onlst" "opf" "parst" "PrimPercentUsed" "PrimsFree" "PrimsFree" "ProtocolData" "ProtocolID" "RemoteDesc" "RemoteGroup" "RemoteIsAttached" "RemoteName" "RemoteOwner" "RemoteOwnerName" "RemotePhantom" "RemotePos" "RemotePrimEqv" "RemoteRScriptCount" "RemoteRoot" "RemoteRootPos" "RemoteRootRot" "RemoteRot" "RemoteScriptTime" "RemoteTScriptCount" "RemoteVelocity" "RPos2Slurl" "SameOwner" "SameParcel" "SetStatus" "SLPPF" "SoundAlert" "SoundDelete" "SoundInvop" "SoundPing" "SoundRezzing" "SoundTyping" "Stridx" "Strlen" "Strtrunc" "StrX" "Substr" "TruncateDialogButton" "TruncateDialogList" "LstIdx" "Len" "FMin" "FMax" "FVecMax" "FVecMin" "MFree" "Max" "Min" "PosOffset" "Signof" "tif" "UnStatus" "VecBetween" "VecFabsSum" "VecMult" "VecRound" "VecSubFAbs" "VecSum" "VecWithin" "Velocity" "VSameParcel" "VVSameParcel"
    )
  "cpp macros")
...
(defvar xlsl-cpp-regexp (regexp-opt xlsl-cpp 'words))
(defvar xlsl-macros-regexp (regexp-opt xlsl-macros 'words))
...
(setq xlsl-font-lock-keywords
  `(
    ...
    (,xlsl-cpp-regexp . font-lock-preprocessor-face)
    (,xlsl-macros-regexp . font-lock-warning-face)
...
Complete documentation at URL `http://xahlee.org/sl/ls-emacs.html'."
  ...
  (cond
   ...
   ((= xlsl-mode-format-style 1) (progn
                                   ...
                                   (c-mode)
;;				   (c-set-offset (quote cpp-macro) 3 nil)
...
;;                                   (c-set-offset 'statement-cont 0))
  ...
  (setq xlsl-cpp-regexp nil)
  (setq xlsl-macros-regexp nil)
